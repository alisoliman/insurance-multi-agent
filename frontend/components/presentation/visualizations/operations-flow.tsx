...
const drains: { id: string; icon: LucideIcon; label: string; color: string }[] = [
  ...
  { id: "context", icon: Workflow, label: "Context switching", color: "#8ecbff" },
]
    ...
    <div className="relative w-full">
      ...
      >
        ...
        <motion.text
          ...
          fill="#fff7ec" fontSize="10" fontWeight="500"
        ...
        {/* Split line */}
        <motion.line
          x1={entryX + 18} y1={entryY} x2={splitX} y2={entryY}
          stroke="rgba(255,255,255,0.18)" strokeWidth={1.5} strokeDasharray="6 8"
        ...
        {drainPositions.map((pos, i) => {
          ...
          return (
            <g key={drain.id}>
              ...
              <motion.circle
                cx={pos.x} cy={pos.y} r={loopRadius}
              ...
              >
                <circle
                  cx={pos.x + loopRadius * 0.65} cy={pos.y - loopRadius * 0.15} r={3}
                  fill={isActive ? drain.color : "rgba(255,255,255,0.3)"}
                />
              </motion.g>

              <motion.text
                x={pos.x + loopRadius + 14} y={pos.y - 6}
                fill={isActive ? "#fff7ec" : "#d1d7df"}
                fontSize="12" fontWeight="500" style={{ cursor: "pointer" }}
              ...
              <motion.line
                x1={pos.x + loopRadius + 8} y1={pos.y} x2={w - 40} y2={pos.y}
        ...
        <motion.text
          x={w - 30} y={24}
          textAnchor="end" fill="#91a6bd" fontSize="9" letterSpacing="0.15em"
