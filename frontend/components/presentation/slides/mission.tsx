          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {pillars.map((pillar) => (
              ...
              >
                ...
                <CardContent className={cn("text-[15px] leading-7 text-[#d1d7df]", isCompact && "pt-0 leading-6")}>
                  {pillar.copy}
                </CardContent>
              </Card>
            ))}
            ...
            >
              ...
              <div className="mt-4 space-y-2">
                {panel.points.map((point) => (
                  <div key={point} className={cn("rounded-2xl border border-white/8 bg-white/6 px-4 py-3.5 text-[15px] leading-7 text-[#d1d7df]", isCompact && "px-3.5 py-2.5 leading-6")}>
                    {point}
                  </div>
                ))}
              </div>
