...
export default function CommunicationAgentDemo() {
  ...
  const formatContent = (content: string) => {
    ...
    // Format communication content with better structure
    if (content.includes('Subject:') || content.includes('Dear') || content.includes('Sincerely')) {
      return (
        <div className="bg-white dark:bg-gray-900 border rounded-lg p-4 font-mono text-sm">
    ...
    <div className="space-y-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold">Communication Agent Demo</h1>
            <p className="text-muted-foreground">
              Test the communication agent that generates customer communications and notifications
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Enter claim details to generate customer communications
                      </CardDescription>
                    </CardHeader>
                            ...
                            >
                              <div>
                                ...
                                <div className="text-xs text-muted-foreground">
                                  {sample.claimant_name} • {sample.claim_id}
                                </div>
                              </div>
                            </Button>
                          ))}
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Customer communication and notification content
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      {error && (
                      ...
                      {result ? (
                        <div className="space-y-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">Communication Generated</span>
                            <Badge variant="default">communication_agent</Badge>
                          </div>
                        ...
                        <div className="text-center py-8 text-muted-foreground">
                          ...
                          <p>Generate a communication to see results here</p>
                        </div>
                      )}
                    </CardContent>
                  </Card>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1">
                          <li>• Generates customer notifications and updates</li>
                          <li>• Creates personalized communication content</li>
                          <li>• Adapts tone and language for different scenarios</li>
                          <li>• Provides clear next steps and instructions</li>
                        </ul>
                      </div>
                      <div>
                        <h4 className="font-medium mb-2">Key Capabilities</h4>
                        <ul className="text-sm text-muted-foreground space-y-1">
                          <li>• Multi-channel communication (email, SMS, letter)</li>
                          <li>• Empathetic and professional tone</li>
                          <li>• Claim status updates and explanations</li>
      ...
      <AgentWorkflowVisualization currentAgent="communication_agent" />
    </div>
  )
} 