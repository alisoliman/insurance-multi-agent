...
Without these variables, the system will use mock responses for demonstration.
...
- Navigate to `/agents/claim-assessor` to test damage photo analysis
- Visit `/agents/policy-checker` to verify coverage scenarios
- Use `/agents/risk-analyst` for fraud detection demos
- Try `/agents/communication-agent` for email generation
...
- Complex multi-vehicle incident
