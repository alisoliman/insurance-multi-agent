...
class LLMComplexityAssessor:
    ...
    async def assess_claim_complexity(self, claim_data: Dict[str, Any]) -> ComplexityAssessment:
        """
        ...
        response_schema = {
            ...
            "required": ["complexity", "confidence_score", "reasoning", "risk_factors",
                         "escalation_recommended", "estimated_processing_time", "required_expertise"]
        }
        ...
        try:
            ...
            # Fallback to a conservative assessment if Azure OpenAI fails
            return ComplexityAssessment(
                complexity=ClaimComplexity.MEDIUM,
                confidence_score=0.5,
                reasoning=f"Azure OpenAI assessment failed: {str(e)}. Using conservative medium complexity.",
                risk_factors=["assessment_failure"],
                escalation_recommended=True,
                estimated_processing_time="3-5 business days",
                required_expertise=["general_adjuster"]
            )
    ...
    def _build_assessment_prompt(self, claim_data: Dict[str, Any]) -> str:
        ...
        docs_status = f"Available: {', '.join(docs_available)}" if docs_available else "No documentation provided"
...
"""
    ...
    async def explain_decision(self, claim_data: Dict[str, Any], assessment: ComplexityAssessment) -> str:
        """
